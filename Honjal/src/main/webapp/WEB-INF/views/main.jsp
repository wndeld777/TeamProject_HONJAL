	...
	<section id="main_slide">
		<div id="slide_img_box">
			<img src="${rootPath}/static/images/sample_slide.jpg"> <img
				src="#" class="slide" alt="집" /> <img src="#" class="slide" alt="집" />
		</div>
...
<article id="main_middle">
	<section id="main_best">
		...
		<div>
			...
			<ol>
				<li class="list_best"><span>1위 </span>1시간만에 끝! 벽걸이 에어컨 분해없는
					셀프청소 노하우</li>
				<li class="list_best"><span>2위 </span>니트 세탁법: 이제 드라이 맡기지 말고 집에서
					손쉽게!</li>
				<li class="list_best"><span>3위 </span>옷은 다 어디에 있냐고요? 예쁜 원룸 속 옷
					수납법!</li>
				<li class="list_best"><span>4위 </span>천연세제 3종의 차이점과 활용법, 정리해봤어요
				</li>
				<li class="list_best"><span>5위 </span>공간에 따른 효율적인 수납Tip을 알아보아요
				</li>
			</ol>
		</div>
	</section>
...
<article id="main_bottom">
	...
	<table class="board">
		...
		<tr>
			<td>15797</td>
			<td>생활TIP</td>
			<td class="td_title">원인 모를 빨래 냄새 없애는, '완벽한' 세탁기 청소법 <span>[7]</span>
			</td>
			<td>빨래널기귀찮아</td>
			<td>09:40</td>
			<td>80</td>
		...
		<tr>
			<td>15794</td>
			<td>랜선집들이</td>
			<td class="td_title">낡은 원룸이 집순이의 아지트로 | 3가지만 기억하세요! <span>[12]</span>
			</td>
			<td>집순이</td>
			<td>09:35</td>
			<td>127</td>
		...
		<tr>
			<td>15792</td>
			<td>공지사항</td>
			<td class="td_title">1인 가구 커뮤니티 '혼자서도 잘해요' <span>[205]</span>
			</td>
			<td>서녕</td>
			<td>09:25</td>
			<td>729</td>
